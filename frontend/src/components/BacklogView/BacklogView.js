...
import {
  ...
  deleteStory,
  updateStory,
} from '../../api_services/userstory.service';
...
import DragDropDemo from '../DragDropDemo/DragDrop';
      ...
      <div className="backlogview-container">
        <div className="backloglist-wrapper productBacklog-light">
          <div className="backloglist__header-wrapper">
            ...
            <button className="add-userstory-btn" onClick={showUserstoryForm}>
              {btnText}
            </button>
          </div>
          {isAddFormVisible ? (
          ...
          <BacklogList
            ...
            getStoryForEdit={(storyId) =>
              getStoryForEdit(storyId, 'product backlog')
            }
          />
        </div>
        <div className="backloglist-wrapper sprintBacklog-light">
          ...
          <BacklogList
            ...
            g
            getStoryForEdit={(storyId) =>
              getStoryForEdit(storyId, 'sprint backlog')
            }
          />
        </div>
      </div>
